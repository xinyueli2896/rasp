...
#
#  The models (matching the results table):
#      adapter_direct   FT w/ rule adapter        . direct
#      adapter_mixed    FT w/ rule adapter        . mixed
#      lora_direct      FT w/ adapter + LoRA      . direct
#      lora_mixed       FT w/ adapter + LoRA      . mixed
#      ft_direct        FT w/o rule adapter       . direct
#      ft_mixed         FT w/o rule adapter       . mixed
#
...
MODELS=(
  "adapter_direct|adapter|checkpoints/pop909_ivvi_w1_direct_only_v3|$ADAPTER_FLAGS"
  "adapter_mixed|adapter|checkpoints/pop909_ivvi_w1_orch_perkey_mixed|$ADAPTER_FLAGS"
  "lora_direct|adapter|checkpoints/pop909_ivvi_w1_adapter_lora16_posqk_direct|$ADAPTER_FLAGS --positional_qk --lora_rank 16"
  "lora_mixed|adapter|checkpoints/pop909_ivvi_w1_adapter_lora16_posqk_mixed|$ADAPTER_FLAGS --positional_qk --lora_rank 16"
